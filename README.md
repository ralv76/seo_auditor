...
[Принципы SEO-аудита со сниженным расходом токенов (INSTRUCTIONS.md)](INSTRUCTIONS.md)

[Документ по формату требований к проекту: проблема-пользователь-функция-результат-MVP-планы развития-технологии (INTRO.md)](INTRO.md)

## Для демонстрации результата вместо скриншотов представлены отчеты - результаты SEO-аудита zerocoder.ru:

[Отчет в формате MarkDown (example_report/report_2026-06-14_175842.md)](example_report/report_2026-06-14_175842.md)

[Отчет в формате HTML (example_report/report_2026-06-14_175842.html)](example_report/report_2026-06-14_175842.html)
